...
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DDL\alter_table_schema.sql') 
# Add in the necessary columns 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DDL\column_additions.sql') 
# SQL script to create the logic for the weight_class column added previously. 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DML\add_weight_class_column_script.sql')
# Alter the schema of the dim_product_details table 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DDL\alter_dim_product_details_table_schema.sql') 
# Next, add the primary keys to the tables 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DDL\add_primary_keys.sql')
# Then add the foreign key constraints to the orders_table 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DDL\orders_table_FK_constraints.sql')
# Lastly map the dimension keys in the dim tables to the foreign keys in the orders_table 
sql_statements.alter_and_update(r'C:\Users\EGuis\MultiRelational_Database\MultiRelational_Database\sales_data\DML\update_orders_table_foreign_keys.sql')